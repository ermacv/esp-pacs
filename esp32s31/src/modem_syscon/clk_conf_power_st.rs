...
pub type CLK_MODEM_PERI_ST_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 4, u8, crate::Safe>;
...
pub type CLK_MODEM_APB_ST_MAP_W<'a, REG> = crate::FieldWriter<'a, REG, 4, u8, crate::Safe>;
impl R {
    #[doc = "Bits 8:11"]
    #[inline(always)]
