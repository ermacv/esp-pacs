...
pub type BSS_CBW_40_DIGITAL_UNKNOWN_W<'a, REG> = crate::FieldWriter<'a, REG, 2, u8, crate::Safe>;
...
pub type BB_AGC_UPDATE_ENABLE_UNKNOWN_W<'a, REG> = crate::FieldWriter<'a, REG, 3, u8, crate::Safe>;
